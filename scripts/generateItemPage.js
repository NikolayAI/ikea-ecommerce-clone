...
export const generateItemPage = () => {
    ...
    const renderCard = (
        ...
        const bredCrumbLink = document.querySelectorAll('.breadcrumb__link')
        ...
        bredCrumbLink[0].textContent = category
        bredCrumbLink[0].href = `goods.html?cat=${category}`
        bredCrumbLink[1].textContent = subcategory
        bredCrumbLink[1].href = `goods.html?subcat=${subcategory}`
        bredCrumbLink[2].textContent = itemName
